...
<template>
  <div class="tutor-info-card flex items-center gap-4 rounded-lg bg-[var(--bg-primary)] " style="box-shadow: 0 0.25rem 1rem rgba(0, 0, 0, 0.1);">
    <div
      :style="{
    ...
    <div class="mr-4">
      ...
      <NButton mode="outline" class="mt-4" @click="toggleClasslistSidebar(details.id)">
        View classes
      </NButton>
    </div>
  </div>
